...
config = {
    ...
    "data_root": os.environ.get("CUHKX_RADAR_DATA_ROOT", "/path/to/CUHK-X/SM/Data"),
    "log_dir": os.environ.get("CUHKX_RADAR_LOG_DIR", "/path/to/CUHK-X/SM/Code/radar/logs_radar_all")
}
