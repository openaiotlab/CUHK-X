...
# ================== setting ==================
DEFAULT_DATASET_PATH = os.environ.get("CUHKX_RGB_DATASET_PATH", "/path/to/CUHK-X/SM_data/RGB")
...
def initialize_action_space(root_dir):
    global ALL_ACTIONS, ACTION_TO_IDX
    ALL_ACTIONS = get_all_action_classes(root_dir)
...
if __name__ == "__main__":
    ...
    initialize_action_space(args.dataset_path)
