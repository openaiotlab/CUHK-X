...
if __name__ == "__main__":
    ...
    if modality == 'rgb':
        gt_path = 'CUHK-X-example/LM/Data/GT_folder/LM_RGB_GT.csv'
    if modality == 'ir':
        gt_path = 'CUHK-X-example/LM/Data/GT_folder/LM_IR_GT.csv'
    if modality == 'depth':
        gt_path = 'CUHK-X-example/LM/Data/GT_folder/LM_Depth_GT.csv'
    if modality == 'thermal':
        gt_path = 'CUHK-X-example/LM/Data/GT_folder/LM_Thermal_GT.csv'
    ...
    output_csv = f'src/task_caption/scores/{modality}/{method}_caption_METEOR.csv'
