...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, required=True, help="Must have model path")
    ...
    if modality == 'thermal':
        ...
        data_dir = "CUHK-X-example/LM/Data/LM_video/Thermal"
    elif modality == 'rgb':
        print("Using RGB modality")
        data_dir = "CUHK-X-example/LM/Data/LM_video/RGB"
    elif modality == 'ir':
        print("Using IR modality")
        data_dir = "CUHK-X-example/LM/Data/LM_video/IR"
    elif modality == 'depth':
        print("Using Depth modality")
        data_dir = "CUHK-X-example/LM/Data/LM_video/Depth"
    else:
    ...
    output_csv = f'{modality}/pred_internvl{model_size}_new.csv'
    ...
    if os.path.exists(output_csv):
        ...
        if len(processed_videos) >= process_num:
            print(
                f"Already processed {len(processed_videos)} samples, which meets or exceeds the target of {process_num}.")
            exit(0)
