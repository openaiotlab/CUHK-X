...
git clone git@github.com:openaiotlab/CUHK-X.git
cd CUHK-X/LM
...
You can download the datasets (GT_folder, LM_video, LM_data) from the homepage [CUHK-X](https://openaiotlab.github.io/CUHK-X/) and save them in the corresponding directories.
